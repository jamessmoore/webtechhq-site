          ...
          <div className="flex items-center gap-2">
            {iconLinks.map(({ href, label, icon }) => (
              <a
                ...
                aria-label={label}
                title={label}
                className="flex items-center justify-center w-14 h-14 border-[0.6px] border-[#1A3D7A] text-[#3A6AAA] transition-colors duration-150 hover:border-[#3D7FD4] hover:text-[#89D4FF]"
