...
const PROOF_POINTS = [
  "A learning prompt built around what you actually want to learn, not a canned tutorial",
  "Tuned to where you're starting from, whether you've never touched AI or you've already dabbled",
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 max-w-[440px]">
          ...
          >
            <span style={{ color: "#EEF6FF" }}>Have AI</span>
            <br />
            <span style={{ color: "#89D4FF" }}>teach you AI</span>
          </h1>
          <p className="text-[21px] leading-relaxed mb-10">
            Everyone tells you to &quot;just use AI&quot; but nobody tells you how to actually
            learn it. Answer four quick questions about where you&apos;re starting from and
            what you&apos;re curious about, and I&apos;ll build you a prompt that turns Claude,
            ChatGPT, or Gemini into a patient, personalized teacher, not a generic tutorial
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 lg:px-12">
        ...
        <div className="w-full max-w-[400px]">
          <div className="mb-8">
            ...
            <p className="text-sm">
              Just your name and email to get started. It&apos;s free and takes about 2 minutes.
            </p>
          </div>

          <SignUpForm
            source="prompt-pilot"
            googleCallbackUrl="/tools/prompt-pilot"
            submitLabel="TRY PROMPT PILOT ›"
            verifyBody="Click it to jump straight into Prompt Pilot."
          />
        </div>
      </div>
    </div>
