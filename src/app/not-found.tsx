      ...
      <main className="min-h-screen pt-[58px] flex flex-col" style={{ backgroundColor: '#040C1C' }}>
        <section className="relative flex-1 flex flex-col items-center justify-center overflow-hidden br-grid px-6 py-24 sm:py-32 text-center">
          ...
          <div className="relative z-10 max-w-xl">
            ...
            >
              <span className="inline-block w-[6px] h-[6px] rounded-full" style={{ backgroundColor: '#E0625B' }} />
              ERROR 404
            </div>
            ...
            <p
              ...
              style={{ color: '#D3D3D3' }}
            >
              Whatever you were looking for got moved, renamed, or never shipped.
              Let&apos;s get you back to something that actually works.
            </p>
