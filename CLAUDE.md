...
- **Lead paragraph** directly under it (Arial, sans-serif): `font-size: 19px`, `color: "#FFFFFF"` (pure white, not the `--brand-white` default).
...
- Secondary/supplementary paragraphs below the main lead paragraph (disclaimers, fine print, perk callouts) keep their own smaller, purpose-specific sizing rather than being bumped to 19px.
